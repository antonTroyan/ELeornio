const initialState = {
    materials: [
        ...
        },
        {
            key: 3,
            hint: 'this is hint 3',
            image: 'https://images.theconversation.com/files/377334/original/file-20210106-15-jyki6r.jpg?ixlib=rb-1.1.0&q=45&auto=format&w=1200&h=1200.0&fit=crop',
            mainText: 'test main text 3',
            title: 'this is test title 3'
        },
        {
            key: 4,
            hint: 'this is hint 4',
            image: 'https://cdn-prod.medicalnewstoday.com/content/images/articles/327/327448/maine-coon-cat.jpg',
            mainText: 'test main text 4',
            title: 'this is test title 4'
        },
    ]
}
