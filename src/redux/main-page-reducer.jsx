    ...
    materials: [
...

        {
            ...
            tasks: [
                ...
                {russianWord: 'getting by', correctAnswer: 'manage with difficulty to live or accomplish something', complexity: 60},
                ...
                {russianWord: 'save up / sock away', correctAnswer: 'accumulate something for a particular purpose [big purchase]', complexity: 60},
                {russianWord: 'fork over', correctAnswer: 'to give something, especially money to someone, especially when you do not want to', complexity: 60},
                {russianWord: 'cough up', correctAnswer: 'give something reluctantly, especially money or information that is due or required', complexity: 60},
                {russianWord: 'shell out', correctAnswer: 'pay a specified amount of money, especially an amount that is resented as being excessive', complexity: 60},
                {russianWord: 'dip into', correctAnswer: 'withdraw something in small amounts, usually money', complexity: 60},
                {russianWord: 'break into [savings]', correctAnswer: 'to start to spend money that you did not want to spend [savings disappears]', complexity: 60},
