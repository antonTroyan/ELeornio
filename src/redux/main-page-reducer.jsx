...
{russianWord: 'tie', correctAnswer: 'a piece of string, cord, or similar used for fastening or tying something', complexity: 60},
{russianWord: 'fastening', correctAnswer: 'a device that closes or secures something', complexity: 60},
{russianWord: 'cord', correctAnswer: 'thin, flexible string or rope made from several twisted strands', complexity: 60},
{russianWord: 'string', correctAnswer: 'material consisting of threads of cotton, hemp, or other material twisted together to form a thin length.', complexity: 60},
{russianWord: 'hemp', correctAnswer: 'the cannabis plant, especially when grown for fibre', complexity: 60},
{russianWord: 'thin', correctAnswer: 'with opposite surfaces or sides that are close or relatively close together', complexity: 60},
{russianWord: 'nab', correctAnswer: 'catch (someone) doing something wrong', complexity: 60},
{russianWord: 'contempt', correctAnswer: 'the feeling that a person or a thing is worthless or beneath consideration', complexity: 60},
{russianWord: 'chump', correctAnswer: 'a foolish or easily deceived person', complexity: 60},
{russianWord: 'chump change', correctAnswer: 'a small or insignificant amount of money', complexity: 60},
{russianWord: 'chop', correctAnswer: 'cut (something) into pieces with repeated sharp blows of an axe or knife', complexity: 60},
{russianWord: 'mole', correctAnswer: 'a small burrowing mammal with dark velvety fur, a long muzzle, and very small eyes', complexity: 60},
{russianWord: 'burrow', correctAnswer: '(of an animal) make a hole or tunnel, typically for use as a dwelling', complexity: 60},
...
{russianWord: 'mercenary', correctAnswer: 'primarily concerned with making money at the expense of ethics', complexity: 60},
{russianWord: 'vile', correctAnswer: 'morally bad; wicked', complexity: 60},
{russianWord: 'moniker', correctAnswer: 'a person\'s name, especially a nickname or alias', complexity: 60},
{russianWord: 'loofah', correctAnswer: 'the fibrous interior of a fruit that resembles a marrow, dried and used as a sponge for washing the body', complexity: 60},
{russianWord: '', correctAnswer: '', complexity: 60},
{russianWord: '', correctAnswer: '', complexity: 60},
{russianWord: '', correctAnswer: '', complexity: 60},
{russianWord: '', correctAnswer: '', complexity: 60},
